...
public class LinkedListDequeTest {
    ...
    public void getTest() {
        ...
        lld1.addFirst(3);
        assertThat(lld1.get(28976)).isNull();
        ...
        lld1.addLast(4);
        lld1.addLast(6);
        assertThat(lld1.get(3)).isEqualTo(6);
    ...
    public void getRecursiveTest() {
        ...
        lld1.addFirst(3);
        assertThat(lld1.getRecursive(28976)).isNull();
        assertThat(lld1.getRecursive(-7)).isNull();
        assertThat(lld1.getRecursive(0)).isEqualTo(3);

        lld1.addLast(2);
        lld1.addLast(4);
        lld1.addLast(6);
        assertThat(lld1.getRecursive(3)).isEqualTo(6);
    ...
    public void removeFirstAndRemoveLastTest() {
        ...
        assertThat(lld1.removeLast()).isEqualTo(2); // [-2, -1, 0, 1]
